            ...
            <main className="px-6 max-w-5xl mx-auto -mt-4 relative">
                ...
                <div className="grid md:grid-cols-3 gap-10">
                                ...
                                <TabsContent value="prizes">
                                    <div className="grid sm:grid-cols-2 gap-4">
                                        {event.prizes.map((prize, i) => (
                                            <div key={i} className="rounded-xl border border-border/60 bg-card/40 p-4 flex items-start gap-3">
                    ...
                    <div className="hidden md:block md:col-span-1">
                        <div className="rounded-2xl bg-gradient-card border border-border/60 p-6 space-y-4 sticky top-28">
