...
import { Plus, Users, Pencil, QrCode, Download, Rocket, Trash2 } from 'lucide-react';
            ...
            <main className="pt-28 pb-20 px-6 max-w-6xl mx-auto">
                <div className="flex items-center justify-between mb-8 flex-wrap gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Manage the events you organize on Ignite Room.</p>
                    </div>
                    {!notOrganizer && (
                ...
                {!loading && events.length > 0 && (
                    <div className="space-y-4">
                        {events.map(event => (
                            <div key={event.id} className="rounded-2xl bg-gradient-card border border-border/60 p-5 flex flex-wrap items-center gap-4 justify-between">
                                <div className="flex-1 min-w-[200px]">
                                    ...
                                    <p className="text-xs text-muted-foreground mt-0.5">
                                        ...
                                        {' · '}<Users className="w-3 h-3 inline -mt-0.5" /> {event._count.registrations} registered
                                    </p>
                                </div>
