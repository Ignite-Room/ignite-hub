    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <a href="#home" onClick={(e) => handleNav('#home', e)} className="flex items-center gap-2 group">
            <motion.img
              src={igniteLogo}
              alt="Ignite Room"
            ...
            />
            <span className="font-heading font-bold text-lg lowercase tracking-tight text-foreground group-hover:text-primary transition-colors">
              Ignite Room
            </span>
          </a>
