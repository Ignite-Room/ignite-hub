...
/** Shown instead of the login form when the visitor already has a live session — matches the Figma "Good to have you back." frame. */
export default function WelcomeBackSplash({ email, onContinue }: WelcomeBackSplashProps) {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#060205] overflow-hidden">
            ...
            <Link to="/" className="absolute top-6 left-6 flex items-center gap-2 z-10">
                ...
                <span className="text-white font-bold">Ignite Room</span>
            </Link>
            <Link to="/" aria-label="Close" className="absolute top-6 right-6 z-10 text-white/50 hover:text-white transition-colors">
                <X className="w-5 h-5" />
            </Link>
            ...
            >
                ...
                <h1 className="font-heading text-4xl md:text-6xl font-bold text-white leading-[1.1] mb-5">
